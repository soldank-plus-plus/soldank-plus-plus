...
[Test Coverage Report](https://soldank-plus-plus.github.io/soldank-plus-plus/coverage/)
[Browser Client](https://soldank-plus-plus.github.io/soldank-plus-plus/browser-client/)
...
Make sure you have CMake, Ninja and mold installed. The project uses [CPM.cmake](https://github.com/cpm-cmake/CPM.cmake) to download required packages.
To build the project, it's recommended to build it using presets:
```
cmake --preset clang-ninja-release-all
cmake --build --preset clang-ninja-release-all
```

compile_commands.json for LSP completion is generated by default in all CMakePresets.
